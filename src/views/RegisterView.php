          ...
          <div class="center-box">
            ...
            <form action="/registrar" method="post">
              <div class="form-group">
                ...
                <span id="register-name-message" class="input-message">message</span>
              </div>

              <div class="form-group">
                <label for="register-email">E-mail:</label>
                <input type="email" name="registerEmail" id="register-email">
                <span id="register-email-message" class="input-message">message</span>
              </div>

              <div class="form-group">
                <label for="register-cpf">CPF:</label>
                <input type="text" name="registerCpf" id="register-cpf">
                <span id="register-cpf-message" class="input-message">message</span>
              </div>

              <div class="form-group">
                <label for="register-password">Senha:</label>
                <input type="password" name="registerPassword" id="register-password">
                <span id="register-password-message" class="input-message">message</span>
              </div>

              <div class="form-group">
                <label for="register-confirm-password">Confirmar Senha:</label>
                <input type="password" name="registerConfirmPassword" id="register-confirm-password">
                <span id="register-confirm-password-message" class="input-message">message</span>
              </div>
